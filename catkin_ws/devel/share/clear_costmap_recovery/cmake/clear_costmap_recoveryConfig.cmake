...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/multipos1/catkin_ws/src/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/multipos1/catkin_ws/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/multipos1/catkin_ws/install)
...
if(NOT "/home/multipos1/catkin_ws/src/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/multipos1/catkin_ws/src/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/multipos1/catkin_ws/src/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
