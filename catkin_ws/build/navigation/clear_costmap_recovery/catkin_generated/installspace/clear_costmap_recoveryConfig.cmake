...
if("FALSE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/multipos1/catkin_ws/src/navigation/clear_costmap_recovery)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/multipos1/catkin_ws/install/${idir}'.  ${_report}")
    endif()
