...
if("FALSE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/multipos5/catkin_ws/src/navigation/rotate_recovery)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/multipos5/catkin_ws/install/${idir}'.  ${_report}")
    endif()
