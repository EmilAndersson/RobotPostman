...
if("FALSE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/multipos1/catkin_ws/src/navigation/costmap_2d)
...
if(NOT "include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/multipos1/catkin_ws/install/${idir}'.  ${_report}")
    endif()
